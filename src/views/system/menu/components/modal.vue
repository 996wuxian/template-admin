...
<script lang="ts" setup>
  ...
  const formConfig = [
    ...
    f('菜单名称', 'title', 'input', 12, '请输入').r(),
    f('图标', 'icon', 'input', 12, '请输入').r(),
    f('路由名称', 'name', 'input', 12, '请输入').r(),
    f('路由路径', 'url', 'input', 12, '请输入').r(),
    ...
    f('是否隐藏', 'hide', 'switch', 12, '请输入').r(),
    f('排序', 'sort', 'input', 12, '请输入').r(),
  ]
</script>
